...
import json
import base64
from settings import dama_password, dama_username
...
class DamatuApi():
    ID = '53482'
    KEY = '0b3875e12ee684fcec0350746759de15'
    HOST = 'http://api.dama2.com:7766/app/'

    def __init__(self, ):
        self.username = dama_username
        self.password = dama_password
    ...
    def decode_by_content(self,content, type):
...
if __name__ == '__main__':
    ...
    import requests
    response = requests.get("http://captcha.qq.com/getimage?aid=549000912&r=0.7257105156128585&uin=3056517021")
    print(dmt.decode_by_content(response.content,200))
